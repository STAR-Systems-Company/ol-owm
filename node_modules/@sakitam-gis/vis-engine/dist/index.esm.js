...
import { add, subtract, multiply, divide, scale, distance, length, squaredDistance, angle, dot, equals, cross, negate, inverse, lerp, normalize as normalize$1, transformMat3, transformMat4 } from 'gl-matrix/vec2';
import { set as set$1, length as length$2, add as add$1, subtract as subtract$1, multiply as multiply$2, divide as divide$1, scale as scale$1, scaleAndAdd, distance as distance$1, squaredDistance as squaredDistance$1, angle as angle$1, dot as dot$2, equals as equals$2, cross as cross$1, negate as negate$1, inverse as inverse$1, lerp as lerp$1, normalize as normalize$3, transformMat3 as transformMat3$1, transformMat4 as transformMat4$1, transformQuat } from 'gl-matrix/vec3';
import { setAxisAngle, getAxisAngle, fromEuler, fromMat3, set, length as length$1, multiply as multiply$1, slerp, invert, conjugate, normalize as normalize$2, dot as dot$1, getAngle, copy } from 'gl-matrix/quat';
import { equals as equals$1, set as set$2, add as add$2, subtract as subtract$2, multiply as multiply$3, divide as divide$2, scale as scale$2, scaleAndAdd as scaleAndAdd$1, distance as distance$2, squaredDistance as squaredDistance$2, length as length$3, dot as dot$3, cross as cross$2, negate as negate$2, inverse as inverse$2, lerp as lerp$2, normalize as normalize$4, transformMat4 as transformMat4$2, transformQuat as transformQuat$1 } from 'gl-matrix/vec4';
import { identity, set as set$3, transpose, invert as invert$1, adjoint, determinant, multiply as multiply$4, translate, rotate, scale as scale$3, fromTranslation, fromRotation, fromScaling, fromQuat, normalFromMat4, fromMat4, frob, add as add$3, subtract as subtract$3, equals as equals$3, copy as copy$1 } from 'gl-matrix/mat3';
import { identity as identity$1, set as set$4, transpose as transpose$1, invert as invert$2, adjoint as adjoint$1, determinant as determinant$1, add as add$4, subtract as subtract$4, multiply as multiply$5, multiplyScalar, translate as translate$1, rotate as rotate$1, scale as scale$4, fromTranslation as fromTranslation$1, fromRotation as fromRotation$1, fromXRotation, fromYRotation, fromZRotation, fromScaling as fromScaling$1, fromRotationTranslation, perspective, ortho, fromQuat as fromQuat$1, equals as equals$4, getRotation, getScaling, getTranslation, rotateX, rotateY, rotateZ, fromRotationTranslationScale, copy as copy$2, frustum, lookAt } from 'gl-matrix/mat4';
...
function highPrecision(b, notifyGlMatrix = true) {
  ...
  if (notifyGlMatrix) {
    glMatrix.setMatrixArrayType(FloatArray);
  }
}
...
class Vector3 extends Vector {
  ...
  addScalar(v) {
    add$1(this.elements, this.elements, [v, v, v]);
    return this;
  }
  subtract(vec) {
  ...
  subtractScalar(v) {
    subtract$1(this.elements, this.elements, [v, v, v]);
    return this;
  }
  subVectors(a, b) {
  ...
  multiplyScalar(v) {
    multiply$2(this.elements, this.elements, [v, v, v]);
    return this;
  }
  divide(vec) {
  ...
  divideScalar(v) {
    divide$1(this.elements, this.elements, [v, v, v]);
    return this;
  }
  scale(s) {
...
class Vector4 extends Vector {
  ...
  addScalar(v) {
    add$2(this.elements, this.elements, [v, v, v, v]);
    return this;
  }
  subtract(vec) {
  ...
  subtractScalar(v) {
    subtract$2(this.elements, this.elements, [v, v, v, v]);
    return this;
  }
  subVectors(a, b) {
  ...
  multiplyScalar(v) {
    multiply$3(this.elements, this.elements, [v, v, v, v]);
    return this;
  }
  divide(vec) {
  ...
  divideScalar(v) {
    divide$2(this.elements, this.elements, [v, v, v, v]);
    return this;
  }
  scale(s) {
...
class Matrix3 extends Matrix {
  ...
  set(m00, m01, m02, m10, m11, m12, m20, m21, m22) {
    set$3(this.elements, m00, m01, m02, m10, m11, m12, m20, m21, m22);
    return this;
  }
  transpose() {
  ...
  scale(v) {
    scale$3(this.elements, this.elements, v.elements);
    return this;
  }
  fromTranslation(v) {
  ...
  equals(a, b) {
    if (b) {
      return equals$3(a.elements, b.elements);
    } else {
      return equals$3(this.elements, a.elements);
    }
  }
  ...
  copy(m) {
    copy$1(this.elements, m.elements);
    return this;
  }
  clone() {
...
class Matrix4 extends Matrix {
  ...
  static get identity() {
    return new Matrix4().fromArray(identity$1([]));
  }
  set(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33) {
    set$4(this.elements, m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33);
    return this;
  }
  transpose() {
  ...
  scale(vec3) {
    scale$4(this.elements, this.elements, vec3.elements);
    return this;
  }
  scaleScalar(s) {
    scale$4(this.elements, this.elements, [s, s, s]);
    return this;
  }
  fromTranslation(vec) {
    fromTranslation$1(this.elements, vec.elements);
    return this;
  }
  fromRotation(rad, axis) {
    fromRotation$1(this.elements, rad, axis);
    return this;
  }
  fromRotationX(rad) {
  ...
  fromScale(vec) {
    fromScaling$1(this.elements, vec.elements);
    return this;
  }
...
export { BlendType, Box, BufferAttribute, Camera, Clock, Color, DataTexture, Euler, EventEmitter, Geometry, Matrix3, Matrix4, Mesh, Object3D, OrthographicCamera, PerspectiveCamera, Plane, Program, ProjectionMatrix, Quaternion, Raf, RenderBuffer, RenderTarget, Renderer, Resource, Scene, State, Texture, Texture3D, Vector2, Vector3, Vector4, getPlaneBuffer, highPrecision, index as utils };
